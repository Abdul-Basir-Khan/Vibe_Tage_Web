...
import 'package:vibe_tag_web/screen/registeration/identity_screen.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ReusableText(title: '🎉 When’s your birthday?',weight: FontWeight.w700,size: 20,color: Color(0xff212121),),
                        const SizedBox(height: 15,),
                        const ReusableText(title: "Tell us more about you! We need this for community\nsafety. ",color: Color(0xff7D8CAC),size: 14,weight: FontWeight.w400,),
                        const SizedBox(
                          height: 20,
                        ),
                        TextField(
